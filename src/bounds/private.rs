...
//     // It's currently not possible to implement SliceRange accurately
//     // for `ops::RangeInclusive<usize>` in a manner where how it works in const is consistent
//     // with `RangeBounds`. Until it is possible, we're just not going to
//     // support it. Period.
//     #[cfg(any())]
...
//             }
//             // This implementation is not accurate to `RangeBounds`, so unforunately
//             // it's just better to not support this type.
//             #[cfg(any())]
